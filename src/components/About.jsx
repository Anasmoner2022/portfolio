      ...
      <div className="container">
        ...
        <div className="bg-zinc-800/50 p-7 rounded-2xl md:p-12">
          ...
          <p className="text-zinc-300 mb-4 md:mb-8 md:text-xl">
            Welcome! I&apos;m Anas, a junior web developer with a knack for crafting visually stunning and highly functional websites.
            combining creativity and technical expertise.
            transform your vision into digital masterpiece that excels in both appearance and performance. 
          </p>
